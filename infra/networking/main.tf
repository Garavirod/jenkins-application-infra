...
output "dev_bookyland_vpc_id" {
  value = aws_vpc.dev_bookyland_vpc_eu_central_1.id
}

output "dev_bookyland_public_subnets" {
...
# Setup VPC
resource "aws_vpc" "dev_bookyland_vpc_eu_central_1" {
...
resource "aws_subnet" "dev_bookyland_public_subnets" {
  ...
  vpc_id            = aws_vpc.dev_bookyland_vpc_eu_central_1.id
...
# Private Route Table
resource "aws_route_table" "dev_bookyland_private_subnets" {
  vpc_id = aws_vpc.dev_bookyland_vpc_eu_central_1.id
...
resource "aws_route_table_association" "dev_bookyland_private_rt_subnet_association" {
  ...
  route_table_id = aws_route_table.dev_bookyland_private_subnets.id
}