...
module "ec2" {
  ...
  subnet_id                = tolist(module.networking.dev_bookyland_public_subnets)[0]
  sg_enable_ssh_https      = module.security_group.sg_ec2_sg_ssh_http_id
  ec2_sg_name_for_python_api     = module.security_group.sg_ec2_for_python_api
  enable_public_ip_address = true
  user_data_install_apache = templatefile("./template/ec2_install.sh", {})
}
...
module "lb_target_group" {
  ...
  vpc_id                   = module.networking.dev_bookyland_vpc_id
  ec2_instance_id          = module.ec2.dev_bookyland_ec2_instance_id
}
...
module "alb" {
  ...
  lb_type                   = "application"
  sg_enable_ssh_https       = module.security_group.sg_ec2_sg_ssh_http_id
  subnet_ids                = tolist(module.networking.dev_bookyland_public_subnets)
  tag_name                  = "dev-proj-1-alb"
  lb_target_group_arn       = module.lb_target_group.dev_bookyland_lb_target_group_arn
  ec2_instance_id           = module.ec2.dev_bookyland_ec2_instance_id
  ...
  dev_bookyland_acm_arn        = module.aws_ceritification_manager.dev_bookyland_acm_arn
...
module "rds_db_instance" {
  source               = "./rds"
  db_subnet_group_name = "dev_bookyland_rds_subnet_group"
  subnet_groups        = tolist(module.networking.dev_bookyland_public_subnets)
